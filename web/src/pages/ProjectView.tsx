...
export default function ProjectView() {
  ...
  if (loading) {
    return (
      <>
        <Helmet>
          <title>Loading shared project — BLUPRNT.AI</title>
  ...
  if (error || !project) {
    return (
      <>
        <Helmet>
          <title>Shared project — BLUPRNT.AI</title>
          <meta name="robots" content={META_ROBOTS_NOINDEX} />
        </Helmet>
        <div className="flex min-h-screen flex-col bg-slate-50">
          <div className="mx-auto flex max-w-md flex-1 flex-col items-center justify-center gap-6 p-6 text-center">
            ...
            <p className="text-sm text-slate-500">
              If you were sent this link, ask them to create a new share link
  ...
  return (
    <>
      <Helmet>
        <title>{project.name} — Shared view — BLUPRNT.AI</title>
        <meta
          name="description"
          content={`Shared renovation summary for ${project.name}.`}
        />
        <meta name="robots" content={META_ROBOTS_NOINDEX} />
        <link
          rel="canonical"
          href={seoAbsoluteUrl(`/project/${token ?? ""}`)}
        />
      </Helmet>
      <div className="flex min-h-screen flex-col bg-slate-50">
        <header className="border-b border-slate-200 bg-white">

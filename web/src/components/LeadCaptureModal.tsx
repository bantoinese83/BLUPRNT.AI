...
type LeadFormValues = { email: string };
...
export function LeadCaptureModal({ onPlanSelect }: LeadCaptureModalProps) {
  ...
  return (
    <ModalDialog
      ...
      overlayClassName="bg-slate-950/60 backdrop-blur-md"
      panelClassName="relative w-full max-w-2xl bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-white/20"
    >
      <button
        type="button"
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                ...
                <span className="font-bold text-slate-700">35% discount</span>.
                We&apos;ll send you the code and our &quot;Budget Guard&quot;
                checklist for free.
              </p>
            </div>

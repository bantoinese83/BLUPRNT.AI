...
export function InsightTeaser({
  ...
  return (
    <div className="p-6 bg-teal-50/30 border-t border-slate-100 relative overflow-hidden group">
      {/* Background glow */}
      <div className="absolute top-0 right-0 w-32 h-32 bg-teal-500/5 blur-2xl rounded-full -mr-16 -mt-16" />

      <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-white shadow-sm border border-teal-100 flex items-center justify-center shrink-0">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-x-0 bottom-0 h-4 bg-gradient-to-t from-teal-50/30 to-transparent" />
            </div>
          </div>
        </div>
        ...
        <Button
          ...
          className="shrink-0 font-bold gap-2 rounded-xl px-5 h-10 premium-gradient shadow-lg shadow-teal-500/20"
        >
          See AI Insights

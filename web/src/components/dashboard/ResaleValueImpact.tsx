...
import { TrendingUp, Info, Crown, Trophy } from "lucide-react";
  ...
  return (
    <Card className="overflow-hidden border-slate-100 shadow-xl shadow-slate-50/50 group">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-black text-slate-500 uppercase tracking-widest flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            <TrendingUp className="w-4 h-4 text-slate-900 shrink-0" />
            <span className="truncate">Resale Value Impact</span>
          </div>
          {investment > 0 && (
            <Badge
              variant="secondary"
              className="bg-teal-950 text-emerald-400 border-teal-900 gap-1.5 text-[9px] font-black uppercase tracking-widest hover:bg-teal-900 transition-colors shrink-0"
            >

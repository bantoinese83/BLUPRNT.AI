  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      ...
      <motion.button
        ...
        className="w-14 h-14 rounded-2xl liquid-metal-button flex items-center justify-center text-white shadow-2xl shadow-teal-950/30 relative overflow-hidden group z-50"
      >

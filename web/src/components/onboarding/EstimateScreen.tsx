    ...
    <PageTransition>
      <div className="space-y-8 py-4">
        ...
        <motion.div
          ...
          className="relative lg:grid lg:grid-cols-5 lg:gap-8 items-start"
        >
          <div className="absolute -inset-4 bg-teal-500/10 blur-3xl rounded-[3rem] -z-10 animate-pulse hidden lg:block" />
          ...
          <div className="lg:col-span-2 space-y-6 mt-8 lg:mt-0">
            {summary?.value_engineering_tips &&
              summary.value_engineering_tips.length > 0 && (
                <div className="rounded-2xl bg-teal-50/50 border border-teal-100/50 p-6 space-y-4 shadow-sm">
                  ...
                  <ul className="space-y-3">
                    {summary.value_engineering_tips.map((tip, i) => (
                      ...
                      >
                        <span className="text-teal-500 font-black mt-0.5">
                          •
                        </span>
                        {tip}
                      </li>
            ...
            {summary?.regional_context && (
              <motion.div
                ...
                className="flex items-start gap-4 p-6 rounded-2xl bg-slate-50 border border-slate-100 shadow-xs"
              >
                <div className="mt-0.5 p-1.5 bg-white rounded-xl shadow-sm border border-slate-200">
            ...
            {!showBreakdown && (
              <div className="rounded-2xl bg-white border border-slate-100 p-6 space-y-4 shadow-sm">
                ...
                <div className="space-y-3">
                  {Array.from(new Set(bullets)).map((item, i) => (
                    <motion.div
                      ...
                      key={`${item}-${i}`}
                      className="flex items-center space-x-3 text-sm text-slate-600 font-medium"
                    >

/**
 * Core loop: regional estimate vs documented capital spend (mobile).
 * Keep in sync with web `src/lib/plan-vs-actual.ts`.
 */
...
export function planVsActualPdfLines(
  ...
  function estimateRangeLabel(min: number | null, max: number | null): string {

...
export const LANDING_HERO_COPY = {
  ...
  body:
    "Bluprnt is a professional home renovation planner and budget tracker. Get grounded cost estimates for kitchen and bathroom remodels, track every invoice against your budget, and see how your renovations build long-term home value.",

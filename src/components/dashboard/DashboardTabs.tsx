...
const tabs = [
  { to: "/dashboard/plan", label: "Plan", subtitle: "Budget & scope", icon: ClipboardList },
  { to: "/dashboard/execute", label: "Execute", subtitle: "Track invoices", icon: Hammer },
  { to: "/dashboard/record", label: "Record", subtitle: "Seller packet", icon: FileText },
] as const;

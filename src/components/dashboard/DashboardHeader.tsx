    ...
    <header className="glass sticky top-0 z-50 border-white/40">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3.5 min-w-0">
          <div className="w-11 h-11 bg-white rounded-2xl flex items-center justify-center shrink-0 shadow-xl shadow-indigo-100/50 ring-4 ring-white border border-slate-100 overflow-hidden">

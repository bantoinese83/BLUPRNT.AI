    ...
    >
      <section>
        ...
        <LegalParagraph>
          ...
          account, use our tools, or upload construction-related documents. This
          includes your name, email address, and any project-related data you
          choose to share with BLUPRNT.
        </LegalParagraph>
      </section>
      ...
      <section>
        ...
        <LegalParagraph>
          ...
          the features of BLUPRNT, including project estimation, document
          handling, and related services. We also use your data to communicate
          with you about updates and support.
        </LegalParagraph>
      </section>
      ...
      <section>
        ...
        <LegalParagraph>
          ...
          personal and project information. Data is stored using providers such
          as Supabase and encrypted in transit. No method of transmission over
      ...
      <section>
        ...
        <LegalParagraph>
          ...
          third-party service providers (such as Stripe for payments) strictly
          as needed to provide our services to you.
        </LegalParagraph>
      </section>
      ...
      <section>
        ...
        <LegalParagraph>
          ...
          your dashboard settings where available. If you have questions about

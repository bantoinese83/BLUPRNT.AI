...
export default function Dashboard() {
  ...
  const handleExportPDF = useCallback(() => {
    ...
    doc.text(`$${project.estimated_min_total?.toLocaleString()} - $${project.estimated_max_total?.toLocaleString()}`, 70, 85);
    ...
    doc.text("This report was generated by BLUPRNT.AI. All benchmarks are regional averages.", 20, 280);
